...
//   virtual unsigned int AddGainsHelper(ControlGainsHelper* gains_helper) = 0;
...
//   unsigned int AddGainsHelper(ControlGainsHelper* gains_helper) override {
//     this->gains_helper = gains_helper;
//     rev::REVLibError err = pid_controller_.SetOutputRange(
//         gains_helper->reverse_peak_output_.value(),
...
//     auto err = gains_helper->Write(pid_controller_, gains_cache_, false);
//     if (err != rev::REVLibError::kOk) return errorParseREVLib(err);
...
// //   unsigned int InitConfigure(units::millisecond_t timeout = 0.0_ms)
// override
// //   {
// //     if (!VerifyConnected()) return -1;
...
// // // //   using V = units::unit_t<units::compound_unit<typename
// X::unit_type,
...
// // // //  public:
// // // //   TalonFXController(Loggable parent_, std::string name, int
// kCanIdPort)
// // // //       : obj(parent_, name),
// // // //         esc_{kCanIdPort},
...
// // // //   int Setup(units::millisecond_t timeout, ControlGainsHelper*
// // gains_helper,
...
// // // //     if (gains_helper != nullptr) {
// // // //       gains_helper->Write(configurator_, deviceConfigs,
// gains_cache_,
// // // false);
// // // //     }
...
// // // //   int Setup(ControlGainsHelper* gains_helper, bool isInverted =
// false,
...
// // // //   util::Converter<X> conv_{util::kTalonPeriod,
// // util::kTalonFXSensorTicks,
