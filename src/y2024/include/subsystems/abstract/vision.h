...
class VisionSubsystem
 ...
 private:
  //   frc846::ntinf::Pref<bool> default_is_red_side_{*this,
  //   "default_is_red_side"};
  ...
  //                                                        "robot_y"};
  //   frc846::ntinf::Grapher<units::foot_t>
  //   speaker_x_dist_graph_{readings_named,
  //                                                               "speaker_dist_x"};
  //   frc846::ntinf::Grapher<units::foot_t>
  //   speaker_y_dist_graph_{readings_named,
  //                                                               "speaker_dist_y"};
  ...
  //                                                      37_deg};
  //   frc846::ntinf::Pref<units::inch_t> camera_y_offset_{*this,
  //   "camera_y_offset",
  //                                                       -10_in};
  //   frc846::ntinf::Pref<units::inch_t> camera_x_offset_{*this,
  //   "camera_x_offset",
  //                                                       -7_in};
