...
struct setpoints {
  static frc846::motion::MotionProfile amp_profile() { 
    return frc846::motion::MotionProfile{
        ...
        {
            frc846::motion::MotionTarget("Pivot", "amp_position", 90_deg),
            frc846::motion::MotionTarget("Telescope", "amp_position", 7.5_in),
            frc846::motion::MotionTarget("Wrist", "amp_position", 30_deg),
        }, 
        {
            1, 1, 1
        }
  ...
  static frc846::motion::MotionProfile intake_profile() { 
    return frc846::motion::MotionProfile{
        ...
        }, 
        {
            ...
            frc846::motion::MotionTarget("Telescope", "intake_position", 0_in),
