#ifndef frcLib846_PREF_H_
#define frcLib846_PREF_H_
...
class Pref {
 public:
  ...
  Pref(const frcLib846::Loggable& parent, std::string name, T fallback);
  Pref(const frcLib846::Loggable& parent, std::string name);
...
template <class U>
Pref<U>::Pref(const frcLib846::Loggable& parent, std::string name, U fallback)
    : Pref{parent,
           fmt::format("{} ({})", name,
...
template <class U>
Pref<U>::Pref(const frcLib846::Loggable& parent, std::string name)
    : Pref{parent,
           fmt::format("{} ({})", name,
                       units::abbreviation(units::make_unit<U>(0))),
           units::make_unit<U>(0),
...
template <>
inline Pref<bool>::Pref(const frcLib846::Loggable& parent, std::string name,
                        bool fallback)
    : Pref<bool>{
          parent,
          name,
...
template <>
inline Pref<double>::Pref(const frcLib846::Loggable& parent, std::string name,
                          double fallback)
    : Pref<double>{
          parent,
          name,
...
template <>
inline Pref<int>::Pref(const frcLib846::Loggable& parent, std::string name,
                       int fallback)
    : Pref<int>{
          parent,
          name,
...
template <>
inline Pref<std::string>::Pref(const frcLib846::Loggable& parent, std::string name,
                               std::string fallback)
    : Pref<std::string>{
          parent,
          name,
