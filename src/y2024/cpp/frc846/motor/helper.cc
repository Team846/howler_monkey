...
//     const Loggable helper, ctre::phoenix6::hardware::TalonFX& esc,
...
// void CTRESetup(const Loggable helper, ctre::phoenix6::hardware::TalonFX& esc,
//                units::millisecond_t timeout) {
...
// bool CTREVerifyConnected(ctre::phoenix6::hardware::TalonFX& esc) {
//   return esc.GetVersion().IsAllGood(); //not correct
